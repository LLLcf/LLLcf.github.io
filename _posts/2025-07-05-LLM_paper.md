...
- [1. Deep Research](#1-deep-research)
- [2. Gated Attention](#2-gated-attention)
- [3. Limit of RLVR](#3-limit-of-rlvr)
- [4. RLEV](#4-rlev)
- [5. DeepSeek-V3.2](#5-deepseek-v32)
- [6. Honesty-LLMs](#6-honesty-llms)
- [7. RL Compute for LLMs](#7-rl-compute-for-llms)
...
**论文标题**: Does Reinforcement Learning Really Incentivize
...
**论文标题**: Every Question Has Its Own Value:
...
**论文标题**: DeepSeek-V3.2: Pushing the Frontier of Open
...
**论文标题**: Training LLMs for Honesty via Confessions
