...
- [目录](#目录)
- [1. Deep Research: A Systematic Survey](#1-deep-research-a-systematic-survey)
  - [摘要](#摘要)
  - [1.1 核心定义与演进路线](#11-核心定义与演进路线)
  - [1.2 数学基础与优化算法](#12-数学基础与优化算法)
    - [1.2.1 强化学习优化目标](#121-强化学习优化目标)
    - [1.2.2 奖励函数设计](#122-奖励函数设计)
  - [1.3 系统四大核心组件](#13-系统四大核心组件)
    - [1.3.1 查询规划 (Query Planning)](#131-查询规划-query-planning)
    - [1.3.2 信息获取 (Information Acquisition)](#132-信息获取-information-acquisition)
    - [1.3.3 记忆管理 (Memory Management)](#133-记忆管理-memory-management)
    - [1.3.4 答案生成 (Answer Generation)](#134-答案生成-answer-generation)
  - [1.4 训练与优化技术流水线](#14-训练与优化技术流水线)
    - [1.4.1 工作流提示工程](#141-工作流提示工程)
    - [1.4.2 监督微调 (SFT)](#142-监督微调-sft)
    - [1.4.3 端到端强化学习](#143-端到端强化学习)
  - [1.5 评估与挑战](#15-评估与挑战)
    - [1.5.1 评估维度](#151-评估维度)
    - [1.5.2 核心挑战](#152-核心挑战)
- [2. Gated Attention for Large Language Models: Non-linearity, Sparsity, and Attention-Sink-Free](#2-gated-attention-for-large-language-models-non-linearity-sparsity-and-attention-sink-free)
  - [摘要](#摘要-1)
  - [2.1 背景与动机](#21-背景与动机)
    - [2.1.1 现有 Transformer 架构的痛点](#211-现有-transformer-架构的痛点)
    - [2.1.2 核心贡献](#212-核心贡献)
  - [2.2 技术原理](#22-技术原理)
    - [2.2.1 最佳门控位置](#221-最佳门控位置)
    - [2.2.2 关键设计要素](#222-关键设计要素)
    - [2.2.3 与现有方法的关联](#223-与现有方法的关联)
  - [2.3 实验结果](#23-实验结果)
    - [2.3.1 核心代码实现](#231-核心代码实现)
    - [2.3.2 性能对比](#232-性能对比)
    - [2.3.3 训练稳定性](#233-训练稳定性)
    - [2.3.4 长文本外推能力](#234-长文本外推能力)
  - [2.4 实施建议](#24-实施建议)
- [3. Does Reinforcement Learning Really Incentivize Reasoning Capacity in LLMs Beyond the Base Model?](#3-does-reinforcement-learning-really-incentivize-reasoning-capacity-in-llms-beyond-the-base-model)
- [4. Every Question Has Its Own Value:Reinforcement Learning with Explicit Human Values](#4-every-question-has-its-own-valuereinforcement-learning-with-explicit-human-values)
- [5. DeepSeek-V3.2: Pushing the Frontier of Open Large Language Models](#5-deepseek-v32-pushing-the-frontier-of-open-large-language-models)
- [6. Training LLMs for Honesty via Confessions](#6-training-llms-for-honesty-via-confessions)
- [7. The Art of Scaling Reinforcement Learning Compute for LLMs](#7-the-art-of-scaling-reinforcement-learning-compute-for-llms)
